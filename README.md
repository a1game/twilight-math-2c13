...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/twilight-math-2c13)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-math-2c13
```

A live public deployment of this template is available at [https://twilight-math-2c13.templates.workers.dev](https://twilight-math-2c13.templates.workers.dev)
